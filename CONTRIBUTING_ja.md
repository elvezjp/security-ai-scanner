...
コントリビューションを提出することで、リポジトリの
[MIT License](./LICENSE)で提供すること、および提出する権利を有することに
同意したものとします。適用される著作権表示とライセンス表示を保持してください。

第三者の素材をコピーまたは実質的に翻案した場合は、出典URL、バージョンまたは
コミット、ライセンスをプルリクエストに記録してください。AI支援による成果も提出者が
責任を持ってレビューし、機密情報を提出せず、生成に用いた重要な第三者の出典を
記録します。必要に応じて[PROVENANCE_ja.md](./PROVENANCE_ja.md)と
[THIRD_PARTY_NOTICES.md](./THIRD_PARTY_NOTICES.md)を更新してください。
